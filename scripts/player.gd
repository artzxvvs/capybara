...
<<<<<<< HEAD
var vida_max: int = 3    # máximo de vidas/corações (mantenha igual ao HUD)
=======
...
func _ready() -> void:
	go_to_idle_state()
>>>>>>> fe7ce67e79cd930dcf385a1b905d655c46844910
...
<<<<<<< HEAD
	...
	if Input.is_action_just_released("jump"):
		Dados.vidas = clamp(Dados.vidas - 1, 0, vida_max)

# Função para recuperar vida ao coletar item
func recuperar_vida():
	Dados.vidas = clamp(Dados.vidas + 1, 0, vida_max)
	print("Vida do Player ao coletar item: ", Dados.vidas)
=======
